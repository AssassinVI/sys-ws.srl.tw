...
$analytics = initializeAnalytics();
  ...
  $pdo=pdo_conn();
  $sql=$pdo->prepare("SELECT google_view_code, Tb_index, StartDate 
                      FROM build_case 
                      WHERE Tb_index IN ('case2021052709080262') AND google_view_code!='' AND is_auto_an=1 
...
function all_Analytics($VIEW_ID, $analytics)
{
  ...
  //---- 月流量來源 ----
  $response = getReport($VIEW_ID, $analytics, '30daysAgo', 'sessions', 'sourceMedium');
