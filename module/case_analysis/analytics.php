...
<link rel="stylesheet" href="../../css/an_style.css?3">
<style>
...
<script type="text/javascript">
  ...
  var data_sex, data_old, data_media, data_tool_btn, data_src_num, data_month_src_num, data_timeOnSite, data_use;
   ...
   $('.print_btn').click(function (e) { 
      ...
      // if($('#an_StartDate').val()=='' && $('.tabs-container li.active a').length<1){
      //   var tag_id='all';
      // }
      // else if($('#an_StartDate').val()!=''){
      //   var tag_id='all';
