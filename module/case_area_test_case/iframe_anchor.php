...
if($_POST){
  ...
  if(empty($_GET['fun_id'])){
    ...
    pdo_insert('anchor_tb', $param, $test_case_db);
  ...
  //----------------- 修改 ----------------------------------------------
    ...
    pdo_update('anchor_tb', $param, ['Tb_index'=>$Tb_index], $test_case_db);
  ...
  $row=pdo_select("SELECT * FROM anchor_tb WHERE Tb_index=:Tb_index", ['Tb_index'=>$_GET['fun_id']], $test_case_db);
?>

<div class="wrapper wrapper-content animated fadeInRight">
	<div class="col-lg-12">
		<h2 class="text-primary"><?php echo $row_case['aTitle'];?>-錨點 <span class="text-danger">(此為測試修改區)</span></h2>
