...
if($_POST){
    ...
    if (!empty($_POST['type']) && $_POST['type']=='delete') { 
        ...
        $otr_file=pdo_select('SELECT img_file FROM img_wall_tb WHERE Tb_index=:Tb_index', $sel_where, $test_case_db);
        ...
        $param=['img_file'=>$new_file];
            ...
            pdo_update('img_wall_tb', $param, $where, $test_case_db);
  ...
  if(empty($_GET['fun_id'])){
    ...
    pdo_insert('img_wall_tb', $param, $test_case_db);
  ...
  //----------------- 修改 ----------------------------------------------
    ...
    if (!empty($_FILES['img_file'])) {
        ...
        $now_file =pdo_select("SELECT img_file FROM img_wall_tb WHERE Tb_index=:Tb_index", $sel_where, $test_case_db);
        ...
        pdo_update('img_wall_tb', $img_file_param, $img_file_where, $test_case_db);
      }
    ...
    pdo_update('img_wall_tb', $param, ['Tb_index'=>$Tb_index], $test_case_db);
  ...
  $row=pdo_select("SELECT * FROM img_wall_tb WHERE Tb_index=:Tb_index", ['Tb_index'=>$_GET['fun_id']], $test_case_db);
?>

<div class="wrapper wrapper-content animated fadeInRight">
	<div class="col-lg-12">
		<h2 class="text-primary"><?php echo $row_case['aTitle'];?>-圖片牆 <span class="text-danger">(此為測試修改區)</span></h2>
