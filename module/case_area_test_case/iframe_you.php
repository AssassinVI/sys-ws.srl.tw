...
if($_POST){
    ...
    if (!empty($_POST['type']) && $_POST['type']=='delete') { 
        ...
        $param=['video_file'=>''];
            ...
            pdo_update('youtube_tb', $param, $where, $test_case_db);
  ...
  if(empty($_GET['fun_id'])){
    ...
    pdo_insert('youtube_tb', $param, $test_case_db);
  ...
  //----------------- 修改 ----------------------------------------------
    ...
    //-------------- 影片修改 ------------------
     ...
     if (!empty($_FILES['video_file']['name'])) {
        ...
        pdo_update('youtube_tb', $video_file_param, $video_file_where, $test_case_db);
    ...
    pdo_update('youtube_tb', $param, ['Tb_index'=>$Tb_index], $test_case_db);
  ...
  $row=pdo_select("SELECT * FROM youtube_tb WHERE Tb_index=:Tb_index", ['Tb_index'=>$_GET['fun_id']], $test_case_db);
...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="col-lg-12">
		<h2 class="text-primary"><?php echo $row_case['aTitle'];?>-YouTube影片 <span class="text-danger">(此為測試修改區)</span></h2>
