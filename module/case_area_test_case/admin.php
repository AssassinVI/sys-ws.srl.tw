...
if ($_GET) {
   ...
   $sql=$pdo->prepare("SELECT Tb_index, aTitle, OrderBy, OnLineOrNot, version FROM build_case WHERE com_id LIKE :com_id AND test_case=0 ORDER BY OrderBy DESC, Tb_index DESC");
