...
<?php 
 ...
 $test_case_db='srltw_test_case'; //-- 測試用修改資料庫 --
  ...
  $row=pdo_select("SELECT * FROM color WHERE Tb_index=:Tb_index", ['Tb_index'=>$_GET['Tb_index']], $test_case_db);
?>

<div class="wrapper wrapper-content animated fadeInRight">
	<div class="col-lg-12">
		<h2 class="text-primary"><?php echo $row_case['aTitle'];?>-更改顏色 <span class="text-danger">(此為測試修改區)</span></h2>
        <p>可改主標、副標、內文、背景</p>
	</div>
	<div class="row">
		<div class="col-lg-12">
