...
if($_POST){
    ...
    if (!empty($_POST['type']) && $_POST['type']=='delete') { 
      ...
      $del_row=pdo_select("SELECT aPic FROM col_word WHERE Tb_index=:Tb_index", ['Tb_index'=>$_POST['fun_id']], $test_case_db);
      ...
      pdo_update('col_word', $param, $where, $test_case_db);
  ...
  if(empty($_GET['fun_id'])){
    ...
    pdo_insert('col_word', $param, $test_case_db);
  ...
  //----------------- 修改 ----------------------------------------------
    ...
    $img_all=pdo_select("SELECT aPic FROM col_word WHERE Tb_index=:Tb_index", ['Tb_index'=>$Tb_index], $test_case_db);
    ...
    pdo_update('col_word', $param, ['Tb_index'=>$Tb_index], $test_case_db);
  ...
  $row=pdo_select("SELECT * FROM col_word WHERE Tb_index=:Tb_index", ['Tb_index'=>$_GET['fun_id']], $test_case_db);
...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="col-lg-12">
		<h2 class="text-primary"><?php echo $row_case['aTitle'];?>-多段圖文 <span class="text-danger">(此為測試修改區)</span></h2>
