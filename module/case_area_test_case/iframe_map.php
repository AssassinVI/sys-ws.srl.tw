...
if($_POST){
  ...
  if(empty($_GET['fun_id'])){
    ...
    pdo_insert('googlemap_tb', $param, $test_case_db);
  ...
  //----------------- 修改 ----------------------------------------------
    ...
    pdo_update('googlemap_tb', $param, ['Tb_index'=>$Tb_index], $test_case_db);
  ...
  $row=pdo_select("SELECT * FROM googlemap_tb WHERE Tb_index=:Tb_index", ['Tb_index'=>$_GET['fun_id']], $test_case_db);
?>
...
<div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="row">
		<div class="col-lg-12">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="location">地圖座標 <span class="text-danger">(此為測試修改區)</span></label>
              <div class="col-sm-10">
