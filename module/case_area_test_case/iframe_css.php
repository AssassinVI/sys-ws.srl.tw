...
<?php 
  ...
  $row=pdo_select("SELECT css FROM change_css WHERE Tb_index=:Tb_index", ['Tb_index'=>$_GET['Tb_index']], $test_case_db);
?>

<div class="wrapper wrapper-content animated fadeInRight">
	<div class="col-lg-12">
		<h2 class="text-primary"><?php echo $row_case['aTitle'];?>-自訂CSS <span class="text-danger">(此為測試修改區)</span></h2>
        <p>直接寫入CSS代碼即可</p>
	</div>
	<div class="row">
		<div class="col-lg-12">
