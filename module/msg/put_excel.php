<?php 
 ...
 /** Include PHPExcel */
require_once "../../core/inc/PHPExcel.php";
 ...
 if ($_GET) {
   ...
   exportDataSelectOptions ($data, $header, $row[0]['aTitle']."-留名單資料-".date('Ymd'));
 }
...
function exportDataSelectOptions ($data, $header, $filename = "data", $spectials=[])
{
    ...
    $objActSheet->getColumnDimension('B')->setWidth(20);//設定欄寬
    ...
    $objActSheet->getColumnDimension('F')->setWidth(25);//設定欄寬
