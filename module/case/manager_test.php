  ...
  // ======================== 刪除 ===========================
	...
	if (empty($_POST['Tb_index'])) {//新增
     ...
     //===================== 分享圖片 ========================
	  ...
	  //-- 剪裁暫存 --
	  elseif(isset($_POST['aPic_box_tmp_img'])){
		$type=pathinfo($_POST['aPic_box_tmp_img'], PATHINFO_EXTENSION);
		$aPic=$Tb_index.date('His').'.'.$type;
		tmp_upload('../../img/tmp/'.$_POST['aPic_box_tmp_img'], $aPic, $Tb_index);
		//fire_upload('aPic', $aPic, $Tb_index);
	  } 
	  else{
      	$aPic='';
				...
				<div class="panel-body">
                  ...
                  <option <?php echo $selected=$row['version']=='2' ? 'selected' : '';?> value="2">全屏滑動版</option>
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<input type="file" name="aPic" class="form-control" accept="image/*" id="aPic" onchange="file_viewer_load_new(this, '#aPic_box')">
								<a href="javascript:;" class="btn btn-success cropper_btn" onclick="cropper_img_box('aPic_box', 1250, 810)">剪裁圖片</a>
							</div>
						</div>

						<div class="form-group">
						   <label class="col-md-2 control-label" ></label>
						   <div id="aPic_box" class="col-md-4">
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<input type="file" name="activity_img" class="form-control" accept="image/*" id="activity_img" onchange="file_viewer_load_new(this, '#activity_img_box')">
							</div>
						</div>

						<div class="form-group">
						   <label class="col-md-2 control-label" ></label>
						   <div id="activity_img_box" class="col-md-4">
