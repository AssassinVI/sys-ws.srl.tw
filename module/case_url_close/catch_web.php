...
<style type="text/css">
	...
	.loading .box{ display: inline-block;}
	 ...
	 @media (max-width:420px){
	   ...
	   { display: block; padding: 10px 5px; border-bottom: 1px solid #e7eaec;}
	   ...
	   #save_url_div tbody tr td button{ padding: 1px 3px;}
				...
				<div id="case_url_div" class="table-responsive">
					<table class="table no-margin">
						...
						<tr>
							...
							<td data-th="網址"><a id="case_url" target="_blank" href="https://<?php echo WEB_HOST;?>/cs/<?php echo $Tb_id;?>/">https://<?php echo WEB_HOST;?>/cs/<?php echo $Tb_id;?>/</a></td>
						</tr>
						<tr>
							<td data-th="#">3</td>
							<td data-th="類型">展示用網址</td>
							<td data-th="網址"><a id="case_url_test" target="_blank" href="https://<?php echo WEB_HOST;?>/test/<?php echo $Tb_id;?>/">https://<?php echo WEB_HOST;?>/test/<?php echo $Tb_id;?>/</a></td>
						</tr>
						<?php 
						 }else{
						?>
                          ...
                          <!-- 建案網址 -->
			              <a style="display" id="case_url"  href="https://<?php echo WEB_HOST;?>/cs/<?php echo $Tb_id;?>/"></a>
...
/* =================================== 產生QR code (自製) ============================================= */
      function get_qrcode_new(get_url, aTitle, show_id,put_id) {
         ...
         $.ajax({
          ...
          success:function (data) {
                       //產生QR_code
              var qr_url='https://chart.googleapis.com/chart?chs=250x250&cht=qr&chl='+data+'&chld=L|1&choe=UTF-8';
	 		...
	 		success:function (data) {
	 			...
	 			$.each(data, function() {
					    ...
					    txt+=`<tr> 
								...
								<td data-th="管理">
								  <a class="btn btn-success del_url_btn admin_show" href="javascript:; " source="${this['source']}" qr_id="${this['Tb_index']}">編輯</a>
