					...
					<table class="table no-margin">
						...
						<?php $i=1; while ($row=$sql->fetch(PDO::FETCH_ASSOC)) {
							...
							<tr>
                                ...
                                <a class="btn btn-success btn-sm" href="edit_list.php?MT_id=<?php echo $_GET['MT_id']?>&Tb_index=<?php echo $row['Tb_index'];?>"><i class="fa fa-line-chart"></i> 分析編輯</a>
			     ...
			     $('#case_tb').html('');
	 			   ...
	 			   var txt='';
	 		   	  $.each(data, function() {
						...
						txt+='    <a class="btn btn-success btn-sm" href="edit_list.php?MT_id=<?php echo $_GET['MT_id'];?>&Tb_index='+this['Tb_index']+'"><i class="fa fa-line-chart"></i> 分析編輯</a>';
						txt+=' </td>';
						txt+='</tr>';
				       x++;
	 			   });
