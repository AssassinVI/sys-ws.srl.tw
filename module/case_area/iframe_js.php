...
<?php 
  ...
  $row=pdo_select("SELECT js FROM change_js WHERE Tb_index=:Tb_index", ['Tb_index'=>$_GET['Tb_index']]);
?>

<div class="wrapper wrapper-content animated fadeInRight">
	<div class="col-lg-12">
		<h2 class="text-primary"><?php echo $row_case['aTitle'];?>-自訂JS</h2>
        <p>直接寫入js代碼即可</p>
	</div>
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="ibox-content">
				  ...
				  <textarea id="edit_js" name="js" class="form-control"  ><?php echo $row['js'];?></textarea>
...
<script type="text/javascript">
	$(document).ready(function() {
       ...
       var myCodeMirror = CodeMirror.fromTextArea(document.getElementById('edit_js'), {
