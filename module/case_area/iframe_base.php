...
if($_POST){
    ...
    if (!empty($_POST['type']) && $_POST['type']=='delete') { 
      ...
      if (!empty($_POST['back_img'])) {
            ...
            unlink('https://'.WEB_HOST.'/product_html/'.$_POST['case_id'].'/img/'.$_POST['back_img']);
      }
        ...
        for ($i=0; $i <count($otr_file)-1 ; $i++) { //比對 
           if ($otr_file[$i]!=$_POST['base_img']) {
            $new_file.=$otr_file[$i].',';
             ...
             unlink('https://'.WEB_HOST.'/product_html/'.$_POST['case_id'].'/img/'.$_POST['base_img']);
           }
        }
        ...
        for ($i=0; $i <count($otr_file)-1 ; $i++) { //比對 
           if ($otr_file[$i]!=$_POST['base_img_ph']) {
            $new_file.=$otr_file[$i].',';
             ...
             unlink('https://'.WEB_HOST.'/product_html/'.$_POST['case_id'].'/img/'.$_POST['base_img_ph']);
           }
        }
    ...
    if (!empty($_FILES['base_img_ph'])) {
        ...
        for ($i=0; $i <count($_FILES['base_img_ph']['name']) ; $i++) { 
            ...
            if (!empty($_FILES['base_img_ph']['name'][$i])) {
               ...
               unlink('https://'.WEB_HOST.'/product_html/'.$_GET['Tb_index'].'/img/'.$_POST['old_ph_img'][$i]);
            }
            else{
	...
	<div class="row">
		<div class="col-lg-12">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-11">
               <button type="button" id="new_OtherFile" class="btn btn-info"><i class="fa fa-plus"></i> 新增檔案</button><br>
                <span class="text-danger">順序由左至右，由上到下 (圖片尺寸:1920*900)</span>
              </div>
            </div>
                                  ...
                                  $base_img=explode(',', $row['base_img']);
                                   for ($i=0; $i <count($base_img)-1 ; $i++) { 
                                     $img_txt='<li class="oneFile_div">
                                                   ...
                                                   <div class="old_file" style="background: url(https://'.WEB_HOST.'/product_html/'.$_GET['Tb_index'].'/img/'.$base_img[$i].') center; background-size: cover;"><p>目前圖檔</p> </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-11">
               <button type="button" id="new_ph_img" class="btn btn-info"><i class="fa fa-plus"></i> 新增檔案</button><br>
                <span class="text-danger">順序由左至右，由上到下 (圖片尺寸:720*900)</span>
              </div>
                                  ...
                                  $base_img_ph=explode(',', $row['base_img_ph']);
                                   for ($i=0; $i <count($base_img_ph)-1 ; $i++) { 
                                     $img_txt='<li class="oneFile_div">
                                                   ...
                                                   <div class="old_file" style="background: url(https://'.WEB_HOST.'/product_html/'.$_GET['Tb_index'].'/img/'.$base_img_ph[$i].') center; background-size: cover;"><p>目前圖檔</p> </div>
            ...
            <?php if(!empty($row['back_img'])){
               $back_img_url='https://'.WEB_HOST.'/product_html/'.$_GET['Tb_index'].'/img/'.$row['back_img'];
              ?>
              <div  class="col-md-4">
                 <div id="img_div" >
                  <p>目前圖檔</p>
