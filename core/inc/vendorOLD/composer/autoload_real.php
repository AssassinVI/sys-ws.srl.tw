...
class ComposerAutoloaderInitc133c63ddd3a35906f40c88617352009
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitc133c63ddd3a35906f40c88617352009::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequirec133c63ddd3a35906f40c88617352009($fileIdentifier, $file);
        }
...
function composerRequirec133c63ddd3a35906f40c88617352009($fileIdentifier, $file)
{
